        ...
        <div className="row">
          ...
          <div className="col-lg-5 col-md-5 col-sm-6 align-items-center">
            <div className="d-flex justify-content-center">
              {/* <FacebookShareButton
                url={"https://github.com/Reksakan/reksa-portfolio"}
              ...
              >
                ...
                <a href="https://www.linkedin.com/in/asker-alshanbayev" target="_blank">
                ...
                <a href="https://github.com/Reksakan" target="_blank">
